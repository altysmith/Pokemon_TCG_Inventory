...
class AppTests(unittest.TestCase):
    ...
    def test_deck_assignments_label_owned_cards_without_moving_locations(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                allocation_summary = refresh_saved_deck_assignments()
        ...
        self.assertEqual(allocation_summary["deck_count"], 1)
        self.assertEqual(allocation_summary["assigned_cards"], 2)
        self.assertFalse(allocation_summary["inventory_changed"])
        self.assertFalse(allocation_summary["locations_changed"])
    ...
    def test_webcam_ui_has_capture_and_cleanup_controls(self) -> None:
        ...
        self.assertIn('id="inventory_export_csv"', inventory_html)
        self.assertIn('id="inventory_export_json"', inventory_html)
        self.assertIn("function prepareCollectionExport", inventory_javascript)
        self.assertIn("collectionExportPayload", inventory_javascript)
        self.assertIn("prepareCollectionExport(event, 'json')", inventory_javascript)
        ...
        self.assertIn('id="deck_view_copy"', inventory_html)
        self.assertIn('id="deck_view_edit"', inventory_html)
        self.assertIn('id="deck_view_allocate"', inventory_html)
        self.assertIn('id="deck_view_delete"', inventory_html)
        self.assertIn('id="allocate_all_decks"', inventory_html)
        self.assertIn('id="deck_editor_allocate"', inventory_html)
        self.assertNotIn("Open full deck check", inventory_html)
        ...
        self.assertIn("async function allocateCardsToDecks", inventory_javascript)
        self.assertIn("async function deleteSelectedDeck", inventory_javascript)
        self.assertIn("'/decks/assign-all'", inventory_javascript)
        self.assertIn("'/decks/remove'", inventory_javascript)
        ...
        self.assertIn(".deck-editor-dialog", stylesheet)
        ...
        self.assertIn('self.path == "/decks/assign-all"', app_source)
        ...
        self.assertIn("Saving automatically labels available owned copies", deck_html)
        self.assertIn("Saving automatically labels available owned copies", deck_javascript)
        ...
        self.assertIn("async function useSameNameSubstitute", deck_javascript)
        self.assertIn("function replaceDeckPrinting", deck_javascript)
        self.assertIn("data-substitute-item", deck_javascript)
        self.assertIn("Use ${card.quantity}×", deck_javascript)
        self.assertIn("await checkCurrentDeck()", deck_javascript)
        self.assertIn("await saveCheckedDeck()", deck_javascript)
        ...
        self.assertIn(".deck-gallery-substitute button", stylesheet)
